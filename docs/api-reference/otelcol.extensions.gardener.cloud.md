...
| --- | --- | --- | --- |
| `targets` _[Target](#target) array_ | Targets is a list of collector destinations. Each target consists of a<br />self-contained exporter, the signals it receives, and its own filter rules. |  | Required: \{\} <br /> |
